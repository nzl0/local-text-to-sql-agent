...
normal bir "SQL çalıştırılamadı" hatası gibi yakalar; Agent'ın auto-fix/retry
döngüsü de bunu diğer DuckDB hatalarından ayırt etmeden modele geri verip
düzelttirmeye çalışır. Guard, mevcut hata-onarım akışına hiçbir özel durum
eklemeden entegre olur.
"""
